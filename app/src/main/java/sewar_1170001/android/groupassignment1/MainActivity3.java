...
public class MainActivity3 extends AppCompatActivity {
    ...
    public void showAccepted(View view) {
        EditText edtEnterDOB = findViewById(R.id.edtEnterDOB);


        String url = "http://10.0.2.2/proj/studentinfo.php?loc=" + edtEnterDOB.getText();
    ...
    private class DownloadTextTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
              EditText txt = findViewById(R.id.textViewid);
              txt.setText(result);
